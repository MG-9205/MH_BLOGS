    ...
    <>
      {userid.User == "" && (
        <div className="flex justify-center items-center h-[100vh]">
          <Link
            to="/LoginPage"
            className="bg-blue-500 text-white text-[1.3rem] px-7 py-3 rounded-[10px]"
          >
            Login
          </Link>
        </div>
      ...
      {userid.User != "" && (
        <div>
          <div className="flex justify-center flex-col items-center gap-4 md:flex-row mt-8">
            <div className="h-[100px] w-[100px] bg-blue-500 text-[4.5rem] text-white text-center rounded-[50%] flex justify-center items-center">
