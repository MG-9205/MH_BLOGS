...
export default function Sidebar1() {
  ...
  return (
    <>
      <div className={`fixed z-10 font-Montserrat bg-white border-r-2 h-[100vh] w-[90wv] ${Sidebar1.SideWidth} overflow-hidden md:w-[26vw] md:translate-x-[0%] transition-all duration-[2s]`}>
    <div className="">
      <ul className="flex flex-col gap-3 justify-start items-start pl-6 pt-5 text-[1.1rem] font-semibold">
        ...
        <li className="hover:text-blue-400 link">
         <a href="https://linktr.ee/manishgupta_31" target='_blank'>Contact me</a>
        </li>
      </ul>
    </div>
    ...
    <div className="flex items-start pl-6 mt-4 text-[0.9rem]">
        ...
        Copyright ©2024 All rights reserved | This website is made with  by Manish Gupta
        </span>
    </div>
  </div>
    </>
