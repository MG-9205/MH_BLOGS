      ...
      <div className="flex justify-center items-center gap-4 flex-col md:flex-row md:gap-2 md:mx-5 md:w-[600px] md:h-[280px] ">
        <div className="flex justify-center items-center md:w-[30%]">
          <img
            src={props.imgurl}
            alt=""
            className="rounded-[50%] h-[12rem] w-[12rem] md:h-[10rem] md:w-[10rem]"
          />
        </div>
        <div className="flex justify-center items-center gap-4 flex-col md:w-[80%]">
          <div className="text-[1.6rem] font-Montserrat font-medium md:text-[1.5rem] text-center">
            {props.title}
          </div>
          ...
          <div>
            <button
              className="text-blue-500 text-[1.5rem] md:text-[1.2rem]"
          ...
          {props.remove == "true" && (
            <div className="flex justify-end w-[100%]">
              <button className="text-white text-[1.1rem] font-semibold bg-red-600 rounded-[7px] px-9 py-1">
                delete
              </button>
            </div>
          )}
